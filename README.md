# Image to Text & Text to Speech App
...
- **Select image from gallery or click it through camera and then can also crop it**
- **Copy whole extracted text in one click**
- **Listen to text in many different accents**
- **Modify speed & pitch of the voice while listening**
